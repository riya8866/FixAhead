    ...
    >
      ...
      >
        <h2 className="text-4xl md:text-5xl font-bold mb-6">
          Road Damage is More Than Just a Bump in the Road
        </h2>
        <p className="text-lg text-gray-300 leading-relaxed">
          Potholes and road damage cost billions in vehicle repairs, cause
          accidents, and reduce the efficiency of our transportation
          infrastructure. Traditional detection methods are slow,
          labor-intensive, and often reactive rather than preventative.
        </p>
      </motion.div>
      ...
      >
        ...
        <div className="lg:w-1/2 space-y-6">
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Beyond vehicle damage, potholes contribute to increased fuel
            consumption, longer travel times, and accelerated wear on public
            transportation. The environmental impact of congestion caused by
            road damage adds an additional layer of costs that are rarely
            calculated.
          </motion.p>
          <motion.div
          ...
          >
            ...
            <p className="text-gray-300">
              Every dollar invested in preventative road maintenance saves
              between $4-$10 in future repair costs.
            </p>
          </motion.div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          ...
          >
            ...
            <p className="text-gray-300">
              Manual inspections require significant time and resources,
          ...
          >
            ...
            <p className="text-gray-300">
              Relies heavily on human observers who can miss damage or misjudge
              severity.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-gray-300">
              Most damage is only addressed after it becomes severe, missing the
